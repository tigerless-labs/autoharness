...
- **[research-loom.md](research-loom.md)** —— 本项目自身的"文献→设计"工作方法：五阶段流水线（捕获→组织→蒸馏→装配⇄精炼）、原子稳定/视图可弃/可溯源的不变量。操作指南见 `research-loom` skill，内容产物见 [`../research-loom/`](../research-loom/index.md)。
