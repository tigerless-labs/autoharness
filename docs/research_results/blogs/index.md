# Blogs & essays — `[博客]` cards

One card per non-paper write-up (essays, practitioner blogs, position posts).

- [符号学习在 Agent 时代的文艺复兴？ (Symbolic-Learning Renaissance)](symbolic-learning-renaissance.md) — Eddy, Zhihu. The framing thesis: symbols as trainable external state; maintenance is the wedge.
